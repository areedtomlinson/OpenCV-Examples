...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define "opencv_examples" do |opencv_examples|
    ...
    opencv_examples.vm.network :private_network, ip: "10.1.2.125"  # Change as you see fit
    opencv_examples.vm.hostname = 'opencv-examples'
    opencv_examples.vm.synced_folder ".", "/var/www", id: "vagrant-root"
    opencv_examples.vm.synced_folder ".", "/home/vagrant", disabled: true

    # If you have performance issues with your Vagrant box,
    # uncomment this and do 'vagrant reload'
    #
